...
<div align="center">
  ...
  # V E R I T A S <sup>v8.0</sup>
  ### The Thermodynamic AI Safety Layer
  **Zero-Training. Non-Statistical. Deterministically Grounded.**
...
Use any LLM (local or API) as a pure "Optic Nerve" to extract Subject-Relation-Object triples. The `VeritasEngine` acts as an unbypassable logic gate.
